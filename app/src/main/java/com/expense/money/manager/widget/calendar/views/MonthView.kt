...
class MonthView : ViewGroup, DatesGridLayout.CallBack {
    ...
    private fun initMonthTitle() {
        mMonthTitleTextView = mLayoutInflater.inflate(R.layout.view_calendar_month_title, null) as TextView
    ...
    private fun initWeekDayHeader() {
        mWeekDaysHeader = mLayoutInflater.inflate(R.layout.view_calendar_weekday_header, null)
